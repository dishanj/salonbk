...
<!-- Mirrored from hencework.com/theme/admintres/demo-2/ by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 23 Sep 2018 09:03:57 GMT -->
<head>
    <meta charset="UTF-8" />
    ...
    <link href="assets/vendors/bower_components/awesome-bootstrap-checkbox/awesome-bootstrap-checkbox.css" rel="stylesheet" type="text/css"/>
    <link href="assets/vendors/bower_components/switchery/dist/switchery.min.css" rel="stylesheet" type="text/css"/>
    <link href="assets/vendors/bower_components/owl.carousel/dist/assets/owl.carousel.min.css" rel="stylesheet" type="text/css"/>
    <link href="assets/vendors/bower_components/owl.carousel/dist/assets/owl.theme.default.min.css" rel="stylesheet" type="text/css"/>
	
	<!-- Chartist CSS -->
	<link href="assets/vendors/bower_components/chartist/dist/chartist.min.css" rel="stylesheet" type="text/css"/>
	<link href="assets/vendors/bower_components/bootstrap/dist/css/bootstrap.min.css" rel="stylesheet" type="text/css"/>
		...
		<!-- Top Menu Items -->
								...
								<li class="product-nicescroll-bar row">
									<ul class="pa-20">
										<li class="col-md-3 col-xs-6 col-menu-list">
											<a href="index-2.html"><div class="pull-left"><i class="ti-dashboard  mr-20"></i><span class="right-nav-text">Analytical</span></div><div class="clearfix"></div></a>
			...
			<div class="fixed-sidebar-left">
				<ul class="nav navbar-nav side-nav nicescroll-bar">
					...
					<li>
						<router-link class="active" to="/dashboard" data-toggle="collapse" >
						<div class="pull-left">
						<i class="ti-dashboard mr-20"></i><span class="right-nav-text">Dashboard</span>
						</div>
						<div class="clearfix"></div>
						</router-link>
					</li>
					...
					<li>
						<router-link class="active" to="/profile" data-toggle="collapse" >
						<div class="pull-left">
						<i class="ti-dashboard mr-20"></i><span class="right-nav-text">Profile</span>
						</div>
						<div class="clearfix"></div>
						</router-link>
					</li>
													...
													<ul class="chat-list-wrap">
														<li class="chat-list">
															<div class="chat-body">
																<a href="javascript:void(0)">
																	<div class="chat-data">
																		<img class="user-img img-circle"  src="assets/img/user.png" alt="user"/>
																		<div class="user-data">
																...
																<a href="javascript:void(0)">
																	<div class="chat-data">
																		<img class="user-img img-circle"  src="assets/img/user1.png" alt="user"/>
																		<div class="user-data">
																...
																<a href="javascript:void(0)">
																	<div class="chat-data">
																		<img class="user-img img-circle"  src="assets/img/user2.png" alt="user"/>
																		<div class="user-data">
																...
																<a href="javascript:void(0)">
																	<div class="chat-data">
																		<img class="user-img img-circle"  src="assets/img/user3.png" alt="user"/>
																		<div class="user-data">
...
<!-- Mirrored from hencework.com/theme/admintres/demo-2/ by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 23 Sep 2018 09:04:19 GMT -->
</html>
