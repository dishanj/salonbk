                  ...
                  <div class="wrapper">
                    ...
                    <div class="tab-content" id="myTabContent">
                      <div class="tab-pane fade show active" id="info" role="tabpanel" aria-labelledby="info">
                        <form action="#">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" v-model="form.name" id="name" placeholder="Change user name">
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" v-model="form.userPhone" id="mobile" placeholder="Change mobile number">
                          </div>
                          <div class="form-group">
                            <label for="email">Email</label>
                            <input type="email" class="form-control" v-model="form.email" id="email" placeholder="Change email address">
                          </div>
                          <div class="form-group">
                            <label for="address">Address</label>
                            <textarea name="address" v-model="form.userAddress" id="address" rows="6" class="form-control" placeholder="Change address"></textarea>
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group mt-5">
                            <button type="submit" @click.prevent="updateInfo"  class="btn btn-success mr-2">Update</button>
                      ...
                      <div class="tab-pane fade" id="avatar" role="tabpanel" aria-labelledby="avatar-tab">
                        ...
                        <form action="#">
                          <input type="file" @change="uploadProfileImg" class="dropify" />
                          <div class="form-group mt-5">
                            <button type="submit" @click.prevent="updateInfo" class="btn btn-success mr-2">Update</button>
                            <button class="btn btn-outline-danger">Cancel</button>
                          </div>
...
export default {
  ...
  methods: {
    getProfilePhoto() {
      let userImage =
        this.form.userImage.length > 200
          ? this.form.userImage
          : "img/profile/" + this.form.userImage;
      //let userImage = "img/profile/" + this.form.userImage;
      return userImage;
    },
    updateInfo() {
      // this.$Progress.start();
  ...
  created() {
    axios.get("api/userProfile").then(({ data }) => this.form.fill(data));
  }
};
</script>
